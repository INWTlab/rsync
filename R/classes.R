...
#' @param host (character) the address to the rsync deamon. NULL for a local rsync connection.
#' @param name (character) the name of the deamon's directory. NULL for a local rsync connection.
...
#' @details
#' \describe{
#'  Establishes a rsync connection with a local directory or a rsync deamon. All arguments are characters.
#' }
#' @rdname rsync-class
#' @export
